...
void auxv32letoh(Elf32_auxv_t *auxv);
void auxv32betoh(Elf32_auxv_t *auxv);
...
void auxv64letoh(Elf64_auxv_t *auxv);
void auxv64betoh(Elf64_auxv_t *auxv);
...
void optionstoh(Elf_Options *options);
void options_hwtoh(Elf_Options_Hw *options_hw);
